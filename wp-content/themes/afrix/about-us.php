...
<?php // the_post_thumbnail(); ?>
 ...
 <section class="who-we-are-section">
    ...
    <section class="whychooseus-section-four" style="background-image: url(<?php bloginfo('template_url') ?>/assets/images/background/bg-23.jpg);">
        <div class="auto-container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 whychooseus-block-four">
                    <div class="inner-box wow fadeInUp animated" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-name: fadeInUp;">
                        ...
                        <div class="text">Support from the Government.</div>
                ...
                <div class="col-lg-3 col-md-6 whychooseus-block-four">
                    <div class="inner-box wow fadeInUp animated" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-name: fadeInUp;">
                        ...
                        <h4>Broad & reliable</h4>
                        <div class="text">Broad & reliable Network worldwide.</div>
                ...
                <div class="col-lg-3 col-md-6 whychooseus-block-four">
                    <div class="inner-box wow fadeInUp animated" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-name: fadeInUp;">
                        ...
                        <div class="text">We offer competitve prices for our customers.</div>
                ...
                <div class="col-lg-3 col-md-6 whychooseus-block-four">
                    <div class="inner-box wow fadeInUp animated" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-name: fadeInUp;">
                        ...
                        <h4>Next door agents</h4>
                        <div class="text">Local partners, employees and agents in each country.</div>
